...
const styles = StyleSheet.create({
  ...
  CheckDateBanner:   { fontSize: 16, color: '#555', fontWeight: 'bold', textDecorationLine: 'underline', marginBottom: 2 },
  PrevBanner:        { fontSize: 16, color: '#616161', fontStyle: 'italic', marginBottom: 4 },
  HatchBanner:       { color: '#444', fontWeight: '500', marginBottom: 4 },
  DateStats:         { marginBottom: 4 },
  DateStat:          { fontSize: 16, color: '#444', marginBottom: 2 },
  ...
  CounterInput: {
    ...
    borderWidth: 1.5, borderColor: '#616161', borderRadius: 4,
    paddingHorizontal: 4, paddingVertical: 4, color: '#000',
  },
  PrevBtn:           { marginTop: 1, alignSelf: 'center' },
  PrevBtnH:         { alignSelf: 'center' },
  PrevBtnLabel:      { fontSize: 16, marginVertical: 2, marginHorizontal: 4 },
  ...
  AgeSexLabel:       { width: 56, fontSize: 16, color: '#444' },
  ...
  AgeCount:          { fontSize: 11, color: '#616161', marginTop: 3 },
  Actions:           { marginTop: 8, gap: 8 },
  SaveRow:           { flexDirection: 'row', gap: 12 },
  ActionBtn:         { flex: 1 },
  DeleteBtn:         { borderColor: 'red' },
  BandSubheader:        { fontWeight: '600', fontSize: 16, color: '#444', marginTop: 4, marginBottom: 4 },
  ...
  NestlingPrior:        { fontSize: 11, color: '#616161' },
