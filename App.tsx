...
export type AppStackParamList = {
  ...
  NestCheckEntry: { CheckId: string; CheckDate: string; SeasonId: string; SiteId: string; CompartmentId: string; CompartmentLabel: string; UnitName: string; ExistingEntryId: string | null };
};
